...
const mlTranslations: Translations = {
  ...
  venueTempleName: "പെരിങ്ങോട്ടുകര സോമശേഖര ക്ഷേത്രം",
  venueDescription: "കേരളത്തിലെ തൃശൂരിൽ ഭഗവാൻ സോമശേഖരനായി (ശിവൻ) സമർപ്പിച്ചിരിക്കുന്ന പുരാതനവും ചരിത്രപ്രസിദ്ധവുമായ ക്ഷേത്രം. സമ്പന്നമായ പൈതൃകം, ആത്മീയ അന്തരീക്ഷം, പരമ്പരാഗത കേരള ശൈലിയിലുള്ള ക്ഷേത്ര വാസ്തുവിദ്യ എന്നിവയാൽ പ്രശസ്തമാണ്.",
...
const enTranslations: Translations = {
  ...
  venueTempleName: "Somasekara Temple, Peringottukara",
  venueDescription: "An ancient and historic temple dedicated to Lord Somasekara (Lord Shiva) in Thrissur, Kerala. Famous for its rich heritage, spiritual ambience, and traditional Kerala style temple architecture.",
